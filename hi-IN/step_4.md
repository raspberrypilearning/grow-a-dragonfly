...
--- task --- Select the **Dragonfly** sprite and add this script:
...
--- task --- Add the **Chomp** sound to the dragonfly and `start`{:class="block3sound"} it when an insect gets eaten:
